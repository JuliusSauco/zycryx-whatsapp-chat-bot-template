...
- La base está normalizada en nueve schemas; `database/schema.sql` provisiona instalaciones nuevas y `database/migrations` evoluciona instalaciones existentes.
