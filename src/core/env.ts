...
export const ENV = {
    ...
    REDIS_REQUIRED: (process.env.REDIS_REQUIRED || 'false').toLowerCase() === 'true',
    REDIS_KEY_PREFIX: process.env.REDIS_KEY_PREFIX || 'zycryx',
    REDIS_CONNECT_TIMEOUT_MS: positiveInteger(process.env.REDIS_CONNECT_TIMEOUT_MS, 5_000),
    REDIS_CACHE_TTL_SECONDS: positiveInteger(process.env.REDIS_CACHE_TTL_SECONDS, 300),
