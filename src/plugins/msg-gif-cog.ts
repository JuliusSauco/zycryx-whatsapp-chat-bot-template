...
const GIF_FOLDER = path.join(process.cwd(), 'media', 'gifs', 'cog')

export default definePlugin({
    help: ['msg-gif-cog'],
    tags: ['fun'],
    command: /^(coger|follar|sexear|sexo)$/i,
    register: false,
    ...
    try {
        ...
        const texto = `😋🔥💗👙 *${senderTag}* se esta cogiendo bien duro a *${mentionedTags.join(', ')}*`
