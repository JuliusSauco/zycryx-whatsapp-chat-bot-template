...
const GIF_FOLDER = path.join(process.cwd(), 'media', 'gifs', 'oral')

export default definePlugin({
    help: ['msg-gif-oral'],
    tags: ['fun'],
    command: /^(blowjob|felacion|chupar|oral)$/i,
    register: false,
