...
const GIF_FOLDER = path.join(process.cwd(), 'resources', 'media', 'reaction-gifs', 'ks')

export default definePlugin({
    help: ['msg-gif-kiss'],
    tags: ['fun'],
    command: /^(kiss|skiss|kis|besos|beso|besar|besando)$/i,
    register: false,
