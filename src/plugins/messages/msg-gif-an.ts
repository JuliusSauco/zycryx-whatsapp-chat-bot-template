...
const GIF_FOLDER = path.join(process.cwd(), 'resources', 'media', 'reaction-gifs', 'an')

export default definePlugin({
    help: ['msg-gif-cog'],
    tags: ['fun'],
    command: /^(cogeranal|anal|por-el-culo|sexo-anal|anosex)$/i,
    register: false,
