...
const GIF_FOLDER = path.join(process.cwd(), 'resources', 'media', 'reaction-gifs', 'pat')

export default definePlugin({
    help: ['msg-gif-pat'],
    tags: ['fun'],
    command: /^(pat|palmaditas|palmada-cabeza|caricia)$/i,
    register: false,
