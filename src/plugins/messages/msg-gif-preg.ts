...
const GIF_FOLDER = path.join(process.cwd(), 'resources', 'media', 'reaction-gifs', 'preg')

export default definePlugin({
    help: ['msg-gif-preg'],
    tags: ['fun'],
    command: /^(preg|embarazado|embarazar|preniado|en-bola)$/i,
    register: false,
