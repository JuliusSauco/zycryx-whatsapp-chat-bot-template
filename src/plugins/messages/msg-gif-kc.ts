...
const GIF_FOLDER = path.join(process.cwd(), 'resources', 'media', 'reaction-gifs', 'kc')

export default definePlugin({
    help: ['msg-gif-kc'],
    tags: ['fun'],
    command: /^(kc|ckiss|beso-mejilla|besito-dulce)$/i,
    register: false,
