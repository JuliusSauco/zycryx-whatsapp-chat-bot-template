...
const GIF_FOLDER = path.join(process.cwd(), 'resources', 'media', 'reaction-gifs', 'ap')

export default definePlugin({
    help: ['msg-gif-ap'],
    tags: ['fun'],
    command: /^(ap|cachetes|agarrar-cachetes|cheeks)$/i,
    register: false,
