...
const GIF_FOLDER = path.join(process.cwd(), 'media', 'gifs', 'spank')

export default definePlugin({
    help: ['msg-gif-cog'],
    tags: ['fun'],
    command: /^(spank|nalgear|nalguear|palmaso|nalgaso)$/i,
    register: false,
