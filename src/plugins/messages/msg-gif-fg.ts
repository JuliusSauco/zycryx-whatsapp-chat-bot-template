...
const GIF_FOLDER = path.join(process.cwd(), 'resources', 'media', 'reaction-gifs', 'fg')

export default definePlugin({
    help: ['msg-gif-fg'],
    tags: ['fun'],
    command: /^(slap|pegar|cachetada|golpear)$/i,
    register: false,
